...
OFFSET_BIAS: Mapping[tuple[str, str], Mapping[float, tuple[float, float]]] = {
    ...
    # n=11987 completed games, residual sd 15.53
    ("ncaaf", "spread"): {
        0.5: (+0.0190, +0.0055), 1.5: (+0.0184, +0.0104), 2.5: (+0.0151, +0.0102),
        3.5: (+0.0141, +0.0129), 4.5: (+0.0150, +0.0159), 5.5: (+0.0136, +0.0133),
        6.5: (+0.0119, +0.0145), 7.5: (+0.0129, +0.0130), 8.5: (+0.0099, +0.0109),
        ...
        21.5: (+0.0023, +0.0032), 22.5: (+0.0017, +0.0027), 23.5: (+0.0011, +0.0026),
        24.5: (+0.0008, +0.0033), 25.5: (-0.0002, +0.0031), 26.5: (-0.0008, +0.0027),
        27.5: (+0.0003, +0.0015), 28.5: (-0.0005, +0.0013),
    },
    # n=11699 completed games, residual sd 16.22
    ("ncaaf", "total"): {
        0.5: (+0.0278, -0.0136), 1.5: (+0.0254, -0.0144), 2.5: (+0.0239, -0.0128),
        3.5: (+0.0238, -0.0082), 4.5: (+0.0247, -0.0075), 5.5: (+0.0267, -0.0074),
        6.5: (+0.0249, -0.0047), 7.5: (+0.0239, -0.0015), 8.5: (+0.0241, -0.0020),
        9.5: (+0.0224, -0.0020), 10.5: (+0.0184, -0.0015), 11.5: (+0.0154, +0.0011),
        12.5: (+0.0107, +0.0015), 13.5: (+0.0089, +0.0037), 14.5: (+0.0074, +0.0043),
        ...
        27.5: (-0.0044, +0.0124), 28.5: (-0.0041, +0.0114),
    },
}
