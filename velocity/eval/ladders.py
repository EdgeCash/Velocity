...
OFFSET_BIAS: Mapping[tuple[str, str], Mapping[float, tuple[float, float]]] = {
    ...
    ("nfl", "spread"): {
        0.5: (+0.0065, +0.0011), 1.5: (+0.0087, +0.0034), 2.5: (+0.0086, +0.0047),
        3.5: (+0.0109, +0.0058), 4.5: (+0.0128, +0.0039), 5.5: (+0.0120, +0.0035),
        6.5: (+0.0107, +0.0075), 7.5: (+0.0104, +0.0080), 8.5: (+0.0062, +0.0069),
        9.5: (+0.0044, +0.0045), 10.5: (+0.0054, +0.0050), 11.5: (+0.0072, +0.0078),
        12.5: (+0.0020, +0.0060), 13.5: (-0.0002, +0.0055), 14.5: (-0.0017, +0.0031),
        15.5: (-0.0063, +0.0013), 16.5: (-0.0072, +0.0008), 17.5: (-0.0087, -0.0025),
        18.5: (-0.0096, -0.0003), 19.5: (-0.0118, -0.0001), 20.5: (-0.0105, +0.0011),
        21.5: (-0.0109, +0.0020), 22.5: (-0.0116, -0.0000), 23.5: (-0.0107, -0.0012),
        24.5: (-0.0093, -0.0018), 25.5: (-0.0076, -0.0030), 26.5: (-0.0079, -0.0043),
        27.5: (-0.0074, -0.0037), 28.5: (-0.0066, -0.0038),
    },
    # n=4113 completed games, residual sd 13.21
    ("nfl", "total"): {
        0.5: (+0.0231, -0.0248), 1.5: (+0.0237, -0.0235), 2.5: (+0.0237, -0.0187),
        3.5: (+0.0295, -0.0142), 4.5: (+0.0286, -0.0086), 5.5: (+0.0280, -0.0076),
        6.5: (+0.0286, -0.0083), 7.5: (+0.0258, -0.0041), 8.5: (+0.0203, -0.0031),
        9.5: (+0.0172, +0.0037), 10.5: (+0.0120, +0.0044), 11.5: (+0.0106, +0.0047),
        12.5: (+0.0116, +0.0093), 13.5: (+0.0109, +0.0113), 14.5: (+0.0093, +0.0151),
        ...
        27.5: (-0.0063, +0.0069), 28.5: (-0.0033, +0.0056),
    },
