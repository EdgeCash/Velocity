...
OFFSET_BIAS: Mapping[tuple[str, str], Mapping[float, tuple[float, float]]] = {
    ...
    ("nfl", "spread"): {
        ...
        9.5: (+0.0219, +0.0189), 10.5: (+0.0230, +0.0216), 11.5: (+0.0239, +0.0245),
    ...
    ("ncaaf", "total"): {
        0.5: (+0.0282, -0.0137), 1.5: (+0.0258, -0.0146), 2.5: (+0.0239, -0.0128),
        ...
        21.5: (+0.0008, +0.0119), 22.5: (-0.0009, +0.0119), 23.5: (-0.0005, +0.0127),
